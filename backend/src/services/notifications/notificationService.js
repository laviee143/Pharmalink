...
class NotificationService {
  ...
  async createOrderNotification(orderId, type, userId) {
    ...
    const message = notificationMessages[type] || 'Order status updated';
  ...
  async createPaymentNotification(paymentId, type, userId) {
    ...
    const message = notificationMessages[type] || 'Payment status updated';
  ...
  async createInventoryNotification(userId, type, data) {
    ...
    const message = notificationMessages[type] || 'Inventory alert';
  ...
  async scheduleNotification(notificationData, scheduledAt) {
    ...
    // For now, we'll just create the notification with a scheduled timestamp
    const notification = await prisma.notification.create({
      data: {
        ...notificationData,
        scheduledAt
